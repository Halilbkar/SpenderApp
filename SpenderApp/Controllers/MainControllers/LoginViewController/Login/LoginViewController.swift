...
class LoginViewController: SubViewController {
    ...
    override func viewWillLayoutSubviews() {
        ...
        NSLayoutConstraint.activate([
            ...
            googleSıgnInButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: CGFloat.dWidth(padding: -16)),
