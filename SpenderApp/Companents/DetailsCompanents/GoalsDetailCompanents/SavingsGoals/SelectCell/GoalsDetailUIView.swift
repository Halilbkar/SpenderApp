...
class GoalsDetailUIView: UIView {
    ...
    override func layoutSubviews() {
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.trailingAnchor.constraint(equalTo: pinButton.leadingAnchor, constant: CGFloat.dWidth(padding: -4)),
            
            editButton.topAnchor.constraint(equalTo: topAnchor),
            editButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: CGFloat.dWidth(padding: -16)),
            
            pinButton.topAnchor.constraint(equalTo: topAnchor),
            pinButton.trailingAnchor.constraint(equalTo: editButton.leadingAnchor, constant: CGFloat.dWidth(padding: -16)),
